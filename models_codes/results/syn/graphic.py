...
plt.savefig('syn_Vpre.eps', format='eps', dpi=5000, transparent = True)
...
plt.savefig('syn_TA.eps', format='eps', dpi=5000, transparent = True)
...
plt.savefig('syn_rB.eps', format='eps', dpi=5000, transparent = True)
...
plt.savefig('syn_Vpos.eps', format='eps', dpi=5000, transparent = True)
...
plt.savefig('syn_TB.eps', format='eps', dpi=5000, transparent = True)
...
plt.savefig('syn_rA.eps', format='eps', dpi=5000, transparent = True)
